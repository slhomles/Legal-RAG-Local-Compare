"""
Demo: So sanh hai phien ban hop dong va sinh bao cao thay doi.

Luong xu ly:
  1. DocumentComparator: truy xuat + goi LLM phat hien thay doi
  2. CitationMapper: anh xa trich dan chinh xac
  3. ReportGenerator: tom tat thay doi quan trong

Su dung:
  python demo_compare_report.py
  python demo_compare_report.py --doc-id Hop_dong_A --old v1 --new v2
"""
import argparse
import json
import sys
...
# Fix Windows terminal encoding (cp1252 -> utf-8) de hien thi tieng Viet
...
def main():
    ...
    print("=" * 60)
    print("DEMO: SO SANH HOP DONG VA SINH BAO CAO")
    print("=" * 60)
