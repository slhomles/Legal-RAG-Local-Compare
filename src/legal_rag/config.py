...
# File này nằm ở: src/legal_rag/config.py -> cần lùi 2 cấp để về root project.
BASE_DIR = Path(__file__).resolve().parents[2]

# Các thư mục dữ liệu
DATA_DIR = BASE_DIR / "data"
RAW_DATA_DIR = DATA_DIR / "raw"                 # Chứa file DOCX/PDF gốc
PROCESSED_DATA_DIR = DATA_DIR / "processed"     # Chứa file text đã qua xử lý
...
for path in [RAW_DATA_DIR, PROCESSED_DATA_DIR, GROUND_TRUTH_DIR, CHROMA_DB_DIR]:
